...
1/ People picture AI answers like a phone book lookup. It's not that.

2/ The model doesn't hold one "correct" business in mind — it holds a
cloud of candidates, then compresses that into a sentence, in an order.

3/ That order is the whole game. Named first and named fourth are
basically different outcomes, not points on the same scale.

4/ In the scoring I built for Foreground: named first = full weight.
...
7/ An AI answer isn't a ranking of your website. It's the model's best
attempt at compressing "who do I tell this person about" into one
sentence.

8/ Stop asking "am I mentioned." Ask where. That gap is the whole story.
