...
12. **$19 single-scan purchase (since 2026-08-24)** — from `index.html`'s
    ...
    Pro."
13. **Blog (since 2026-08-24)** — `/blog` and `/blog/<slug>/`, e.g.
    `/blog/ai-is-the-new-front-page/`. **Not covered by `npm run dev`** —
    the blog is generated by `scripts/build-blog.mjs` as a step *after*
