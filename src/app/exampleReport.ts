...
export const EXAMPLE_REPORT: ValidatedPayload = {
  ...
  competitorTallies: [
    { name: 'Roto-Rooter', mentionCount: 6, beatBrandCount: 3, ambiguous: false },
    { name: 'Mr. Rooter Plumbing', mentionCount: 3, beatBrandCount: 2, ambiguous: false },
  ],
  score: 40,
  advice: [
    {
      id: 'mixed',
      tone: 'neutral',
      params: { ranked1: 2, beaten: 5, notMentioned: 3, completedCalls: 10 },
    },
    {
      id: 'top-rival',
      tone: 'neutral',
  ...
  ownSiteCitations: [
    { promptIndex: 0, model: 'google/gemini-3-flash-preview', url: 'https://acmeplumbing.com', title: 'Acme Plumbing Co. — 24/7 Emergency Plumbing' },
    { promptIndex: 2, model: 'google/gemini-3-flash-preview', url: 'https://acmeplumbing.com', title: 'Acme Plumbing Co. — 24/7 Emergency Plumbing' },
  ],
  sentimentJudgments: [
    { promptIndex: 0, model: 'google/gemini-3-flash-preview', classification: 'recommended', reasoning: 'Named as highly recommended with specific positive qualifiers (same-day response, licensed technicians).' },
  ...
  harmonia: {
    ...
    coreWebVitals: {
      strategy: 'mobile', performanceScore: 68, seoScore: 92, accessibilityScore: 81, bestPracticesScore: 96,
      lcpMs: 2400, clsScore: 0.08, inpMs: 180,
      additionalAudits: [
        { id: 'hreflang', label: 'hreflang tags are valid (if present)', passed: null },
        ...
        { id: 'color-contrast', label: 'Text has sufficient color contrast', passed: false },
        { id: 'link-text', label: 'Links have descriptive text', passed: true },
      ],
    },
    securityHeaders: [
